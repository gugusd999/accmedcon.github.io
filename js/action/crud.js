define(['jquery', 'crud', 'crud2', 'crud3', 'axios', 'helper', 'crudtransaksi'], function($, crud, crud2, crud3, axios, helper, crudtransaksi){
  ...
  $("body").on("click", "button[go-back-crud-view-duo]", function(){
  ...
  $("body").on("click", "button[crud-data-hapus-duo]", function(){
  ...
  $("body").on('click', '[close-modal]', function(event){
    ...
    let namaTable = $(this).attr('master');


    $(`body #modal-${namaTable}`).css(`display`, `none`);
  ...
  $("body").on('click', '[modal-show-data]', function(event){
    ...
    let namaTable = $(this).attr('table-name');
    let data = $(this).attr('table-show');

    $(`body #modal-${namaTable}`).css(`display`, `block`);
  ...
  $('body').on('click', '[data-go-print]', function(event){
    event.preventDefault()
    let url = $(this).attr('data-go-print');
  ...
  $('body').on('click', '[kembali-ke-sebelum-nya]', function(event){
    ...
    let nama = helper.sesiGet('nameTable');
